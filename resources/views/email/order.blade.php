        ...
        <tbody>
            <tr>
                <td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p style="color: #777777; letter-spacing: 0.5px;">Order ID is:{{ $mailData['order']->id }}
                                    </p>  
                                    @endif
                                    {{-- <p style="color: #777777;">Payment Is Successfully Processsed And Your Order Is On
                                        The Way</p>
                    ...
                    <table class="order-detail" style="margin-top: 10px;width:100%;" border="0" cellpadding="0" cellspacing="0"
                        align="left">
                        <tbody>
                            <tr align="left">
                                <th>Product</th>
