                ...
                <td>
                    <table align="center" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <p style="color: #777777;">You have received contact mail from {{ $mailData['name'] }}</p>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                <td>
                                    <h2 class="title">{{ $mailData['subject'] }}</h2>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td
                                    ...
                                    <p
                                        style="text-align: left;font-weight: normal; font-size: 14px; color: #000000;line-height: 21px;    margin-top: 0;">Name : {{ $mailData['name']}}</p>
                                    <p  style="text-align: left;font-weight: normal; font-size: 14px; color: #000000;line-height: 21px;    margin-top: 0;">Email : {{ $mailData['email'] }}</p> 
                                    <p  style="text-align: left;font-weight: normal; font-size: 14px; color: #000000;line-height: 21px;    margin-top: 0;">Subject : {{ $mailData['subject'] }}</p> 
                                    <h3  style="text-align: left;font-weight: normal; font-size: 14px; color: #000000;line-height: 21px;    margin-top: 0;">Message : </h3>
                                    <p  style="text-align: left;font-weight: normal; font-size: 14px; color: #000000;line-height: 21px;    margin-top: 0;">{{ $mailData['message'] }}</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
