                    ...
                    <div class="card-body">
                        @if ($brands->isNotEmpty())
                            ...
                            <div class="form-check mb-2">
                                <input {{ (in_array($brand->id, $brandArray)) ? 'checked' : '' }} class="form-check-input brand-label" name="brand[]" type="checkbox" value="{{ $brand->id}}" id="brand-{{ $brand->id }}">
                            ...
                            <div class="ml-2">
                                <div class="btn-group">
                                    ...
                                    <select name="sort" id="sort" class="form-control">
                                        <option value="letest" {{ ($sort == 'letest') ? 'selected' : '' }}>Letest</option>
                            ...
                            <div class="card product-card">
                                <div class="product-image position-relative">
                                    ...
                                    @if (!empty($productImage->image))
                                        <img src="{{ asset('uploads/product/small/'.$productImage->image)}}" class="card-img-top" width="50" >
                                        @else
                                        <img src="{{ asset('admin-assets/img/default-150x150.png')}}"  class="card-img-top" width="50">
                                    @endif
                                    </a>
